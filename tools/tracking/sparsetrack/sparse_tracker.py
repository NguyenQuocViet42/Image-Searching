...
class SparseTracker(object):
    def __init__(self, frame_rate = 30, 
        ...
        self.det_thresh = detect_thresh
        self.track_thresh = self.det_thresh
    ...
    def update(self, in_dets, in_confs, in_clss, curr_img = None):
        self.frame_id += 1
        if self.frame_id == 1:
            self.pre_img = None
        ...
        if len(in_dets) != 0:
            ...
            inds_low = scores > self.high_thresh
        ...
        for t in output_stracks:
            ...
            out = np.array([x1, y1, x2, y2, t.track_id, t.score, 0])

            out_track.append(out)

        # return output_stracks
        return np.array(out_track)
